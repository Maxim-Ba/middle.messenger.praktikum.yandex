...
<head>
  ...
  <link rel="stylesheet" href="./chats.sass">
      ...
      <main class="chats">
        <header class="chats__header">
          <div class="chats__current-chat">
            <img class="chats__current-chat-pic" src="../../../static/img/Chat-picture.svg"
        ...
        <menu class="chats__menu">
          <div class="chats__menu-content" id="chats">
            ...
            <div class="chats__menue-item">
              <img src="../../../static/img/Change-ava-chat.svg" alt="Изменить аватар чата"
